    ...
    return (
      <div className="my-10 md:mx-20 relative">
        ...
        data-aos="fade-up"
          ...
          className="height-70vh lg:height-90vh xl:height-90vh py-4"
        >
          <div
          data-aos="fade-up"
          className="absolute inset-0 bg-black bg-opacity-70 flex flex-col justify-center items-center text-white ">
            <div className="mx-4 md:mx-8 lg:mx-16 xl:mx-20 text-center">
              ...
              <button data-aos="fade-up" className="px-4 md:px-6 lg:px-8 py-2 md:py-3 lg:py-4 xl:py-5 text-white border bg-blue-500 mt-4 md:mt-6 lg:mt-8 xl:mt-10">
